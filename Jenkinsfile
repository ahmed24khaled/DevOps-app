        ...
        parallel {
              ...
              stage('CheckStyle') {
                  ...
                  steps {
                    ...
                    recordIssues(aggregatingResults: true, tools: [checkStyle(pattern: '**/target/checkstyle-result.xml')])
                  }
              }
        }
      }
